...
def analyze_reviews(reviews):
    ...
    return {
        ...
        'highest_rating_review': highest_rating_review,  # 단일 객체
        'lowest_rating_review': lowest_rating_review,    # 단일 객체
        'highest_rating_reviews': list(highest_rating_reviews),  # 리스트
        'lowest_rating_reviews': list(lowest_rating_reviews),    # 리스트
